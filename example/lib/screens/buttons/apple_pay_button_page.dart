...
class ApplePayButtonPage extends StatelessWidget {
  const ApplePayButtonPage({super.key});

  // Common constants
  static const String _demoOrderId = 'order_123';
  static const int _demoAmount = 5000;
  static const String _demoCurrency = 'USD';
